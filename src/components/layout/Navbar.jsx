...
export default function Navbar() {
   ...
   const { count: wishlistCount } = useWishlist();          // ← FIXED (was outside)
         ...
         <nav style={{
            ...
            <div style={{
               ...
               <div style={{ display: "flex", alignItems: "center", gap: 2, flex: 1, justifyContent: "flex-end" }}>
                  ...
                  {/* Search */}
                  <div
                     className="vn-search-wrap"
                     style={{
                        position: "relative",
                        width: searchFocused ? "260px" : "180px",
                        transition: ".3s"
                     }}
                  >
                     <FaSearch
                  ...
                  <Link to="/wishlist" className="vn-icon" style={iconBtn}>
                     ...
                     {badge(wishlistCount)}   {/* ← wishlist count badge */}
                  </Link>

                  {/* Cart icon + badge */}
                  <Link to="/cart" className="vn-icon" style={iconBtn}>
               ...
               <div style={{
                  ...
                  <div style={{ padding: "28px 28px 48px" }}>
                     ...
                     <div style={{ display: "flex", gap: 10, marginTop: 32 }}>
                        {[
                           { icon: <FaHeart size={13} />, to: "/wishlist", label: "Wishlist", count: wishlistCount },
                           { icon: <FaUser size={13} />, to: "/profile", label: "Account", count: 0 },
                        ].map(({ icon, to, label, count }) => (
                           <Link
                              key={to} to={to}
                              onClick={() => setMobileOpen(false)}
                              style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "12px 8px", border: `1px solid ${B.border}`, borderRadius: 2, color: B.textMuted, textDecoration: "none", fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", fontFamily: "'DM Sans', sans-serif", position: "relative" }}
                           >
                              {icon} {label}
                              {count > 0 && (
                                 <span style={{ marginLeft: 4, background: B.accent, color: B.bg, borderRadius: "50%", width: 16, height: 16, fontSize: 8, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center" }}>
                                    {count}
                                 </span>
                              )}
                           </Link>
